...
class SequenceDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        self.load_demo_info(filter_by_attribute=self.filter_by_attribute, cuda_mark=cuda_mark)
    ...
    def load_demo_info(self, filter_by_attribute=None, demos=None, cuda_mark=None):
        """
        Args:
        ...
        device = TorchUtils.get_torch_device(try_to_use_cuda=True, cuda_mark=cuda_mark)
